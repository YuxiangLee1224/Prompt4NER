...
# We made modifications based on the original foundation.
...
def devcollate(data):
    ...
    batch_in_length = []
    for item in data:
        # item -> support_encoded_prompt_in,support_encoded_prompt_out,support_encoded_raw_sent,support_mask_encoded_prompt_out
        prompt_in = []
        prompt_out = []
        masked_prompt_out = []
        attention_mask = []
