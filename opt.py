...
def get_args():
    ...
    parser.add_argument("--log_output_path", default='./pred/debug_10_shot/log.txt', type=str,
    ...
    parser.add_argument('--test_path',default='./prompt_data/MIT_M/')
    parser.add_argument('--pred_path',default='./pred/')
    parser.add_argument('--test_file',default='debug_10_shot')
